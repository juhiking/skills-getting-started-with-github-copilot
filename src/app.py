...
activities = {
    ...
    "Soccer Team": {
        "description": "Team practice and friendly matches for all skill levels",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["james@mergington.edu", "emma@mergington.edu"]
    },
    "Swimming Club": {
    ...
    "Music Ensemble": {
        "description": "Play instruments together and prepare performances",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 14,
    ...
    "Robotics Workshop": {
        "description": "Build robots and learn engineering principles",
        "schedule": "Fridays, 3:30 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["noah@mergington.edu", "mila@mergington.edu"]
    }
}
